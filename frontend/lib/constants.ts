...
export const AUTH_TOKEN_COOKIE = "dimplom_access_token";
export const AUTH_ROLE_COOKIE = "dimplom_user_role";
export const AUTH_EXPIRES_COOKIE = "dimplom_access_expires_at";
export const AUTH_REFRESH_COOKIE = "dimplom_refresh_token";
...
export const EXAMINATION_DRAFTS_KEY = "dimplom-examination-drafts";
