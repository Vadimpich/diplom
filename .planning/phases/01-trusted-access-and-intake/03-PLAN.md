...
depends_on:
  - 01-PLAN.md
files_modified:
  - /home/katya/dimplom/frontend/app/api/auth/login/route.ts
  - /home/katya/dimplom/frontend/app/api/auth/refresh/route.ts
  - /home/katya/dimplom/frontend/app/api/auth/logout/route.ts
  - /home/katya/dimplom/frontend/app/api/auth/session/route.ts
  - /home/katya/dimplom/frontend/lib/api/client.ts
  - /home/katya/dimplom/frontend/lib/auth.ts
  - /home/katya/dimplom/frontend/lib/constants.ts
...
must_haves:
  ...
  artifacts:
    - path: /home/katya/dimplom/frontend/app/api/auth/login/route.ts
      provides: frontend BFF login bridge
    - path: /home/katya/dimplom/frontend/app/api/auth/session/route.ts
      provides: frontend session bootstrap route
    - path: /home/katya/dimplom/frontend/lib/api/client.ts
      provides: BFF-backed auth client transport
  key_links:
    - from: /home/katya/dimplom/frontend/lib/api/client.ts
...
<task id="1-03-01" type="auto">
  ...
  <acceptance_criteria>
    `rg -n "app/api/auth/login/route.ts|app/api/auth/refresh/route.ts|app/api/auth/logout/route.ts|app/api/auth/session/route.ts" /home/katya/dimplom/.planning/phases/01-trusted-access-and-intake/03-PLAN.md`
  </acceptance_criteria>
  <done>
...
<task id="1-03-02" type="auto">
  ...
  <acceptance_criteria>
    `rg -n "BFF|/api/auth/login|/api/auth/refresh|/api/auth/logout|/api/auth/session" /home/katya/dimplom/docs/01_contract.md`
  </acceptance_criteria>
  <done>
