...
files_modified:
  ...
  - /home/katya/dimplom/core-backend/migrations/000003_refresh_sessions.down.sql
  - /home/katya/dimplom/core-backend/db/queries/auth.sql
  - /home/katya/dimplom/core-backend/db/sqlc/auth.sql.go
  - /home/katya/dimplom/core-backend/db/sqlc/models.go
  - /home/katya/dimplom/core-backend/internal/auth/service.go
  - /home/katya/dimplom/core-backend/internal/auth/repository.go
  - /home/katya/dimplom/core-backend/internal/auth/jwt.go
  - /home/katya/dimplom/core-backend/internal/http/auth_handler.go
  - /home/katya/dimplom/core-backend/internal/http/router.go
  - /home/katya/dimplom/core-backend/internal/http/auth_handler_test.go
  - /home/katya/dimplom/core-backend/internal/auth/service_test.go
...
must_haves:
  ...
  artifacts:
    - path: /home/katya/dimplom/core-backend/migrations/000003_refresh_sessions.up.sql
      provides: refresh session persistence
    - path: /home/katya/dimplom/core-backend/internal/http/auth_handler.go
  ...
  key_links:
    - from: /home/katya/dimplom/core-backend/internal/http/auth_handler.go
      to: /home/katya/dimplom/core-backend/internal/auth/service.go
...
<task id="1-01-01" type="auto">
  ...
  <verify>
    <automated>cd /home/katya/dimplom/core-backend && go test ./internal/http ./internal/auth -run 'TestLogin|TestRefresh|TestLogout|TestMe' -count=1</automated>
  </verify>
  <acceptance_criteria>
    `rg -n "CREATE TABLE refresh_sessions|token_hash BYTEA|replaced_by_session_id" /home/katya/dimplom/core-backend/migrations/000003_refresh_sessions.up.sql`
  </acceptance_criteria>
  <done>
...
<task id="1-01-02" type="auto">
  ...
  <read_first>
    /home/katya/dimplom/AGENTS.md
    /home/katya/dimplom/.planning/phases/01-trusted-access-and-intake/01-VALIDATION.md
    /home/katya/dimplom/docs/01_contract.md
    /home/katya/dimplom/docs/02_implementation.md
  </read_first>
  <action>
  ...
  <verify>
    <automated>cd /home/katya/dimplom/core-backend && go test ./internal/http ./internal/auth -run 'TestLogin|TestRefreshRotation|TestLogoutRevokesSession|TestMe' -count=1</automated>
  </verify>
  <acceptance_criteria>
    `rg -n "/auth/login|/auth/refresh|/auth/logout|HttpOnly|refresh session" /home/katya/dimplom/docs/01_contract.md`
  </acceptance_criteria>
  <done>
