...
files_modified:
  - /home/vadim/diplom/core-backend/migrations/000004_examination_question_snapshots.up.sql
  - /home/vadim/diplom/core-backend/migrations/000004_examination_question_snapshots.down.sql
...
must_haves:
  ...
  artifacts:
    - path: /home/vadim/diplom/core-backend/migrations/000004_examination_question_snapshots.up.sql
      provides: examination_questions schema
    - path: /home/vadim/diplom/core-backend/internal/examinations/repository.go
...
<task id="1-04-01" type="auto">
  ...
  <verify>
    <automated>cd /home/vadim/diplom/core-backend && go test ./internal/examinations -run 'TestCreateExaminationSnapshotsQuestions|TestCreateExaminationRejectsInvalidQuestionnaire' -count=1</automated>
  </verify>
  <acceptance_criteria>
    `rg -n "CREATE TABLE examination_questions|UNIQUE \\(examination_id, position\\)" /home/vadim/diplom/core-backend/migrations/000004_examination_question_snapshots.up.sql`
  </acceptance_criteria>
  <done>
...
<task id="1-04-02" type="auto">
  ...
  <acceptance_criteria>
    `rg -n "examination_questions|POST /examinations" /home/vadim/diplom/docs/01_contract.md`
  </acceptance_criteria>
  <done>
