...
- [ ] **ADMN-01**: Администратор может просматривать список пользователей с их ролями и статусом доступа
- [ ] **ADMN-02**: Администратор может создавать, редактировать и изменять роль пользователя через UI с серверной валидацией прав
